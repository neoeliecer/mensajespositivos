...
if __name__ == "__main__":
    search_pattern = r"C:\Users\neo\.gemini\antigravity\brain\44552523-1476-4629-84f4-21d0b5e74ff6\portada_placebo_capitulo_3_*.png"
    files = glob.glob(search_pattern)
    if not files:
        print("No input image found.")
    else:
        input_img = max(files, key=os.path.getctime)
        output_img = r"C:\Users\neo\Documents\agente\mensajes positivos\portada_placebo_capitulo_3_con_titulo.png"
        add_text_to_image(input_img, output_img, "El Placebo", "en el Cerebro", "El placebo eres tú - Capítulo 3")
