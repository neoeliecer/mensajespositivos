...
if __name__ == "__main__":
    search_pattern = r"C:\Users\neo\.gemini\antigravity\brain\c7469211-3b59-42bf-b039-81ee95bec3fd\portada_placebo_capitulo_1_*.png"
    files = glob.glob(search_pattern)
    if not files:
        print("No input image found.")
    else:
        input_img = max(files, key=os.path.getctime)
        output_img = r"C:\Users\neo\.gemini\antigravity\brain\c7469211-3b59-42bf-b039-81ee95bec3fd\portada_placebo_capitulo_1_con_titulo.png"
        add_text_to_image(input_img, output_img, "¿Es Posible?", "", "El placebo eres tú - Capítulo 1")
