...
if __name__ == "__main__":
    search_pattern = r"C:\Users\neo\.gemini\antigravity\brain\cdcff3da-131c-4842-84ff-18b542003d54\portada_manos_capitulo_2_base_*.png"
    files = glob.glob(search_pattern)
    if not files:
        print("No input image found.")
    else:
        input_img = max(files, key=os.path.getctime)
        output_img = r"C:\Users\neo\Documents\agente\mensajes positivos\portada_manos_capitulo_2_con_titulo.png"
        add_text_to_image(input_img, output_img, "El Despertar", "de la Percepción", "Manos que curan - Capítulo 2")
