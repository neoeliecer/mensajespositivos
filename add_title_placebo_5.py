...
if __name__ == "__main__":
    search_pattern = r"C:\Users\neo\.gemini\antigravity\brain\fcda4265-34b7-4317-9ae1-fe8e937c9ab2\portada_placebo_capitulo_5_base_*.png"
    files = glob.glob(search_pattern)
    if not files:
        print("No input image found.")
    else:
        input_img = max(files, key=os.path.getctime)
        output_img = r"C:\Users\neo\Documents\agente\mensajes positivos\portada_placebo_capitulo_5_con_titulo.png"
        add_text_to_image(input_img, output_img, "Repaso", "Mental", "El placebo eres tú - Capítulo 5")
