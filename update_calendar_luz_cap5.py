...
POST_FILE = "post_facebook_luz_cap5.md"
...
def update_csv():
    ...
    row = {
        "Libro": "luz",
        "Capitulo": "5",
        "Titulo": "Hágase la Luz Cap 5: Médico o Sanador",
    ...
    if file_exists:
        with open(CSV_FILE, "r", encoding="utf-8-sig", newline="") as f:
            ...
            for r in reader:
                if not (r.get("Libro", "").lower() == "luz" and str(r.get("Capitulo", "")) == "5"):
                    rows.append(r)
    ...
    print(f"Updated {CSV_FILE} con el Libro luz y Capitulo 5")
