...
def add_text_to_image(input_path, output_path, line1, line2, chapter_text):
    ...
    while (l1_w > max_allowed_w or l2_w > max_allowed_w) and title_font.size > 20:
        ...
        title_font = ImageFont.truetype(title_font.path if hasattr(title_font, 'path') else r"C:\Windows\Fonts\georgiab.ttf", new_size)
        l1_w, l1_h = get_text_size(line1, title_font)
        l2_w, l2_h = get_text_size(line2, title_font)
...
if __name__ == "__main__":
    input_img = r"c:\Users\neo\Documents\agente\mensajes positivos\portada_musica_capitulo_11.png"
    output_img = r"c:\Users\neo\Documents\agente\mensajes positivos\portada_musica_capitulo_11_con_titulo.png"
    add_text_to_image(input_img, output_img, "El Poder de los", "Poetas-Videntes", "Capítulo 11")
