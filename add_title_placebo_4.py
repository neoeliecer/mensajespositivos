...
def add_text_to_image(input_path, output_path, line1, line2, chapter_text):
    ...
    if title_font_path:
        ...
        chapter_font = ImageFont.load_default(size=40)
...
if __name__ == "__main__":
    search_pattern = r"C:\Users\neo\.gemini\antigravity\brain\fcda4265-34b7-4317-9ae1-fe8e937c9ab2\portada_placebo_capitulo_4_base_*.png"
    files = glob.glob(search_pattern)
    if not files:
        print("No input image found.")
    else:
        input_img = max(files, key=os.path.getctime)
        output_img = r"C:\Users\neo\Documents\agente\mensajes positivos\portada_placebo_capitulo_4_con_titulo.png"
        add_text_to_image(input_img, output_img, "El Placebo", "en el Cuerpo", "El placebo eres tú - Capítulo 4")
